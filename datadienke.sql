...
CREATE TABLE GIADIEN (Mabac int NOT NULL, Tenbac nvarchar(255) NOT NULL, Tusokw int NOT NULL, Densokw int NOT NULL, Dongia money NOT NULL, Ngaythanhlap datetime NOT NULL, PRIMARY KEY (Mabac));
